...
#parameters -- (img,circle_method,dp,,mindst,parm1,parm2[p1>p2])
...
while True:
    ...
    #parameters -- (img,circle_method,dp,,mindst,parm1,parm2[p1>p2])
    circles = cv2.HoughCircles(gray,cv2.HOUGH_GRADIENT,1,220,param1 = 50,param2 = 30,minRadius = 0,maxRadius =0)
